...
/**
 * Servlet implementation class UpdateWorkassignServlet
 */
@WebServlet("/UpdateWorkassignServlet")
public class UpdateWorkassignServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateWorkassignServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Service.UpdateWorkAssignTable(wid,job,location);
