...
/**
 * Servlet implementation class ViewIncomeandExpenseServlet
 */
@WebServlet("/ViewIncomeandExpenseServlet")
public class ViewIncomeandExpenseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewIncomeandExpenseServlet() {
        super();
