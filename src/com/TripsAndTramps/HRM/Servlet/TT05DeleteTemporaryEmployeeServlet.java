...
/**
 * Servlet implementation class DeleteTemporaryEmployeeServlet
 */
@WebServlet("/TT05DeleteTemporaryEmployeeServlet")
public class TT05DeleteTemporaryEmployeeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05DeleteTemporaryEmployeeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Service.deleteTemporaryEmp(tid);
