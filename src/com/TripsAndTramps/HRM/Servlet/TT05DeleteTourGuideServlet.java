...
/**
 * Servlet implementation class DeleteTourGuideServlet
 */
@WebServlet("/TT05DeleteTourGuideServlet")
public class TT05DeleteTourGuideServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05DeleteTourGuideServlet() {
        super();
