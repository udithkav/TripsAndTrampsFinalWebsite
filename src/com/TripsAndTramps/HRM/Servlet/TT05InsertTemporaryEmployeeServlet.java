 ...
 */
@WebServlet("/TT05InsertTemporaryEmployeeServlet")
public class TT05InsertTemporaryEmployeeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05InsertTemporaryEmployeeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Service.insertTEmp(firstname, lastname, salary, dob, email, nic);
