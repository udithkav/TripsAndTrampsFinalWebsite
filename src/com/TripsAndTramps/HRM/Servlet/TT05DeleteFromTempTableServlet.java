...
/**
 * Servlet implementation class DeleteFromTempTableServlet
 */
@WebServlet("/TT05DeleteFromTempTableServlet")
public class TT05DeleteFromTempTableServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05DeleteFromTempTableServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			Service.DeleteFromTempTable(id);
