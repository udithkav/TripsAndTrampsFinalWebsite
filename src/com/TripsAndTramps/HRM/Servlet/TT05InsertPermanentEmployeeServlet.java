...
/**
 * Servlet implementation class InsertPermanentEmployeeServlet
 */
@WebServlet("/TT05InsertPermanentEmployeeServlet")
public class TT05InsertPermanentEmployeeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05InsertPermanentEmployeeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Service.insertPEmp(firstname, lastname, salary, position, dob, email, nic);
