...
/**
 * Servlet implementation class ToTourguideReviewPageServlet
 */
@WebServlet("/TT05ToTourguideReviewPageServlet")
public class TT05ToTourguideReviewPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TT05ToTourguideReviewPageServlet() {
        super();
