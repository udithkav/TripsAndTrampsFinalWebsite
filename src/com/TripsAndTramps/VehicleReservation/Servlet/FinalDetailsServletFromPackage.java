...
/**
 * Servlet implementation class FinalDetailsServletFromPackage
 */
@WebServlet("/FinalDetailsServletFromPackage")
public class FinalDetailsServletFromPackage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FinalDetailsServletFromPackage() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Double Total = amount * kilometers;
