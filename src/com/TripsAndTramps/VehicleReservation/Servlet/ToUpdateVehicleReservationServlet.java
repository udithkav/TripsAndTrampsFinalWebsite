...
/**
 * Servlet implementation class ToUpdateVehicleReservationServlet
 */
@WebServlet("/ToUpdateVehicleReservationServlet")
public class ToUpdateVehicleReservationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ToUpdateVehicleReservationServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {	
			...
			RequestDispatcher RD = request.getRequestDispatcher("/02UpdateReservation.jsp");
