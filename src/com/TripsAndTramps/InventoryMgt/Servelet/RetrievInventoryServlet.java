...
/**
 * Servlet implementation class RetrievInventoryServlet
 */
@WebServlet("/RetrievInventoryServlet")
public class RetrievInventoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RetrievInventoryServlet() {
        super();
