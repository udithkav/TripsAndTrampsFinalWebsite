...
<body style="background-image: url(TourGuideReservation/img/iii.jpg);background-size: 110%;background-repeat: no-repeat;"><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <h4 style="color: white;max-width: 403px;position: absolute;left: 56%;top: 367px;">: from <%=TGR.getFromm() %> to <%=TGR.getToo() %></h4>
    <h4 style="color: white;max-width: 263px;position: absolute;left: 38%;top: 414px;">Total</h4>
    <h4 style="color: white;max-width: 200px;position: absolute;left: 56%;top: 413px;">:<%=TGR.getAmt() %></h4>
    <form action="ToUpdateFormServlet" method="POST"><input type="hidden" name="rid" value="<%=TGR.getId()%>"><button class="btn btn-primary" type="submit" style="position: absolute;left: 38%;top: 459px;width: 275px;">Update</button></form>
    <form action="DeletePackageReservationServlet" method="POST"><input type="hidden" name="tgrid" value="<%=TGR.getId()%>"><button class="btn btn-primary" type="submit" style="position: absolute;left: 60.5%;top: 459px;width: 275px;">Delete</button></form>
