...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="register-photo" style="width: 75%;margin-left: 220px;position: absolute;background-color: rgb(245,242,242);height: 570px;">
        <div class="form-container">
            <form method="post" action="UpdateInventoryServlet" style="width: 400px;margin-top: 0px;">
                <h2 class="text-center"><strong>Add Inventory</strong></h2>
                <div class="form-group">
                <% Inventory i = (Inventory)request.getAttribute("inven");%>
                <input class="form-control" type="text"  value="<%=i.getInventory_id() %>" placeholder="Inventory Id" disabled>
                <input class="form-control" type="hidden" name="id" value="<%=i.getInventory_id() %>">
                <input class="form-control" type="text" style="margin-top: 20px;" value="<%=i.getInventory_type() %>" placeholder="Inventory Type" name="type">
                <input class="form-control" type="text" style="margin-top: 20px;" value="<%=i.getBrand() %>" name="brand" placeholder="Brand"></div>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(21,200,60);">Update</button></div>
            </form>
        </div>
    </div>
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="width: 220px;height: 570px;margin-top: 3px;margin-left: 0;position: absolute;background-color: rgb(78,115,223);">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" role="presentation"></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="table.html"><span>Air Condtioners</span></a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="login.html"><span>Televisions</span></a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="register.html"><span>Beds</span></a></li>
            </ul>
        </div>
    </nav>
