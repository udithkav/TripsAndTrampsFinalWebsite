...
<body"><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="register-photo" style="width: 82.75%;margin-left: 220px;position: absolute;background-color: rgb(245,242,242);height: 650px;padding-top: 30px;">
        <div class="form-container">
            <form method="post" action="AddVehicleServlet" style="width: 400px;margin-top: 0px;height: 400px;">
                <h2 class="text-center"><strong>Add Vehicle</strong></h2>
                <div class="form-group" style="width: 340px;">
                <input class="form-control" type="text" name="no" placeholder="Vehicle No">
                <select class="form-control"name="vtype" id="vehicle_t" style="margin-top: 20px;">
   <option value="Vehicle Type">Vehicle Type</option>
  <option value="Car">Car</option>
  <option value="Van">Van</option>
  </select>
                <input class="form-control" type="text" style="margin-top: 20px;" name="vbrand" placeholder="Brand">
                <input class="form-control" type="number" style="margin-top: 20px;" name="nos" placeholder="No of Seats">
                <input class="form-control" type="text" style="margin-top: 20px;" name="model" placeholder="Model"></div>
                <div class="form-group" style="width: 340px;margin-left: 430px;margin-bottom: 40px;margin-top: -296px;">
                    <input class="form-control" type="text" name="von" placeholder="Owners Name">
                    <input class="form-control" type="text" style="margin-top: 20px;" placeholder="Languages" name="language">
                    <input class="form-control" type="number" style="margin-top: 20px;" name="age" placeholder="Age">
                     <input class="form-control" type="number" style="margin-top: 20px;" name="phone" placeholder="Phone Number">
                      <select class="form-control"name="ac" id="vehicle_a" style="margin-top: 20px;">
   <option value="A/c">A/C</option>
  <option value="Available">Available</option>
  <option value="Unavailable">Unavailable</option>
  </select></div>
  <input class="form-control" type="number" style="margin-top: 10px;" name="amount" placeholder="Amount">
        <div
            class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(21,200,60);margin-top: 37px;width: 770px;">Add Vehicle</button></div>
    </form>
    </div>
    </div>
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="width: 220px;height: 647px;margin-top: 3px;margin-left: 0;position: absolute;background-color: rgb(78,115,223);">
    ...
    <div class="footer-dark" style="margin-top: 650px;">
        <footer>
            <div class="container">
                <div class="row">
