...
<head>
    ...
    <title>Turnover Employee List</title>
...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <h5 class="text-center" style="margin-top: 75px;">Employee Turnover Table</h5>
    <div class="table-responsive" style="padding: 100px;padding-top: 25px;margin-top: 0px;">
        <table class="table">
            ...
            <tbody>
               <%List<Employeee> PE = (List<Employeee>)request.getAttribute("deletedemployee"); 
