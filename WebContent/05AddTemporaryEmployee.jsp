...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="contact-clean" style="margin-top: 0px;background-color: rgb(255,255,255);">
        <form method="post" action="TT05InsertTemporaryEmployeeServlet" style="background-color: rgb(217,217,217);">
            <h2 class="text-center">&nbsp;Add Temporary Employee</h2>
            <div class="form-group">
            <input class="form-control" type="text" name="firstname" placeholder="Fname" style="margin-top: 0px;" required><small class="form-text text-muted" style="font-size: 16px;">First Name</small>
            ...
            <input class="form-control" type="text" name="nic" style="margin-top: 30px;" placeholder="NIC" maxlength="10" pattern="[0-9]{9}[A-Z]{1}" required><small class="form-text text-muted" style="font-size: 16px;">National Identity Card No</small>
            <button class="btn btn-primary" type="submit" style="margin-top: 50px;margin-left: 120px;font-size: 13px;background-color: rgb(86,221,38);">ADD EMPLOYEE</button>
