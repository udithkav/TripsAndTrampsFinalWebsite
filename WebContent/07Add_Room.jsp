...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="width: 220px;height: 570px;margin-top: 3px;margin-left: 0;position: absolute;background-color: rgb(78,115,223);">
        <div class="container-fluid d-flex flex-column p-0">
            <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <div class="sidebar-brand-text mx-3"><span style="font-size: 25px;">Rooms</span></div>
            </a>
    ...
    <div class="register-photo" style="width: 83.8%;margin-left: 220px;position: absolute;background-color: rgb(245,242,242);height: 570px;padding-top: 30px;margin-top: 0px;">
        <div class="form-container" style="margin-top: 50px;">
            <form method="post" action="AddRoomServlet" style="width: 400px;margin-top: 0px;height: 400px;">
                <h2 class="text-center"><strong>Add Room</strong></h2>
                <div class="form-group" style="width: 780px;"><input class="form-control" type="text" name="room_id" placeholder="Room Id"><input class="form-control" type="text" style="margin-top: 20px;" placeholder="Employee Id" name="peid"><input class="form-control" type="text" style="margin-top: 20px;"
                        name="rtype_id" placeholder="Room Type Id"></div>
               
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(21,200,60);margin-top: 53px;width: 770px;">Add Rooms</button></div>
            </form>
        </div>
    </div>
