...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" action="UpdateWorkassignServlet" style="width: 238px;height: 516px;">
                <h2 class="text-center" style="margin-left: 60px;margin-top: 100px;"><strong>Work Assignment</strong></h2>
                 <%Work_assign work = (Work_assign)request.getAttribute("work");
              		%>
              		<input type="hidden" name="wid" value="<%=work.getWorkID()%>">
              		<input type="hidden" name="tid" value="<%=work.getTid()%>">
                <div class="form-group"><input type="text" class="form-control" name="namee" value="<%=work.getName()%>" style="margin-top: 0px;margin-bottom: 27px;width: 400px;margin-left: 220px;" disabled/>
                <input type="text" class="form-control" name="job" value="<%=work.getJob()%>" style="margin-top: 0px;margin-bottom: 27px;width: 400px;margin-left: 220px;" /></div>
                <div class="form-group"><input type="text" class="form-control" name="location" value="<%=work.getLocation()%>" style="margin-top: 19px;width: 400px;margin-left: 220px;" /></div>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="width: 146px;margin-left: 366px;background-color: rgb(0,123,255);">Update</button></div>
            </form>
        </div>
    </div>
