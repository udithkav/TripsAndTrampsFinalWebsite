...
<body style="background-image: linear-gradient(to bottom right, #24478f,#000033);"><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="contact-clean" style="max-width: 629PX;margin-top: 153PX;margin-left: 35%;">
        <form method="post" action="InsertFeedbackServlet">
            <h2 class="text-center">Feedback</h2>
            
            <div class="form-group"><textarea class="form-control" name="description" placeholder="description"  rows="14" pattern="[A-Za-z]{10}"></textarea></div>
