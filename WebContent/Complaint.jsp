...
<body style="background-image: linear-gradient(to bottom right, #24478f,#000033);"><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="contact-clean" style="width: 50%;margin-left: 25%;">
        <form method="post" action="InsertComplaintServlet">
            <h2 class="text-center">Complaint</h2>
            <div class="form-group"><textarea class="form-control" name="Description" placeholder="Description" rows="14"></textarea></div><button class="btn btn-primary" type="submit" style="margin-left: 150px;">Submit</button></form>
    </div>
