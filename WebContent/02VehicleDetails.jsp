...
<body style="width: 100%;height: 1235px;background-image: linear-gradient(to bottom right, #24478f,#000033);background-repeat: no-repeat;"><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <h3 style="color: white;max-width: 200px;position: absolute;left: 57%;top: 236px;">Vehicle Brand</h3>
        ...
        <h3 style="color: white;max-width: 263px;position: absolute;left: 57%;top: 361px;">Amount For Oneday</h3><h3 style="width: 350px;position: absolute;font-size: 20px;color: white;left: 75%;top: 371px;">: <%=v.getAmount()%></h3>
        
        
        <form method="POST" action="GetVehicleDetailsServlet"><input type="hidden" value="<%=v.getVehicleType()%>" name="vehicle_type"><input type="hidden" value="<%=v.getVehcleBrand()%>" name="vehicle_brand"><button class="btn btn-primary" type="submit" style="position: absolute;left: 58%;top: 663px;width: 275px;">Back</button></form>
        <form method="POST" action="ToConfirmationServlet"><input type="hidden" value="<%=v.getVehicleNumber()%>" name="vehicle_number"><input type="hidden" value="<%=v.getAmount()%>" name="amount"><button class="btn btn-primary" type="submit" style="position: absolute;left: 80%;top: 663px;width: 275px;">Confirm</button></form>
