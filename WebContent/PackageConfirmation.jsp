...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="contact-clean" style="background-image: url(TourGuideReservation/img/l.jpg);background-size: 100%;">
            ...
            <div class="form-group"><label style="font-size: 20px;margin-left: 540px; background-color:blue;"><strong>Do You Need A Package</strong></label></div><label style="font-size: 20px;"></label>
            
            
            
            
        <form method="POST" action="ToPackageServlet"><button class="btn btn-primary" type="submit" style="margin-left: 100px;margin-top: 50px;">Yes</button></form><form method="POST" action=""><button class="btn btn-primary"
            type="submit" style="margin-left: 225px;margin-top: -230px;">No</button></form></div>
