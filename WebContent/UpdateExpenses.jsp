...
<body><nav class="navbar navbar-light navbar-expand-md navigation-clean bg-light sticky-top">
    ...
    <div class="contact-clean">
        ...
        <%List<expense> i = (List<expense>)request.getAttribute("expensesdetails");
                 for(expense exp:i){%>
            <h2 class="text-center">Update Expenses</h2>
            <label>Expense ID</label>
            <div class="form-group"><input class="form-control" value="<%=exp.getEx_id()%>" type="text" name="Ex_id" placeholder="ID"></div>
            <label>DATE</label>
            <div class="form-group"><input class="form-control" value="<%=exp.getDate()%>" type="text" name="date" placeholder="Date"></div>
            <label>DETAILS</label>
            <div class="form-group"><input class="form-control" value="<%=exp.getDetails()%>" type="text" name="details" placeholder="Details"></div>
            <label>AMOUNT</label>
            <input class="form-control" value="<%=exp.getAmount()%>" type="text" name="amount" placeholder="Amount">
            <%} %>
