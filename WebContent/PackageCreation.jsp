...
<body>
	...
	<div class="form-1">
		<form method="POST" action="insertPackageServlet">
			<h1>Create Package</h1>
			<div class ="form-inner">
				<div class="input-holder">
					<input type="text" class="input-text" name="ActivityName" required>
					<span class="label">Activity Name</span>
				</div>
		
				<div class="input-holder">
					<input type="text" class="input-text" name="TRName" required>
					<span class="label">Tour Guide Name</span>
				</div>
				
				<div class="input-holder">
					<input type="text" class="input-text" name="Amount" required>
				...
				<div class="input-holder">
					<input type="text" class="input-text" name="Location" required>
