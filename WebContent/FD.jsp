<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.TripsAndTramps.FC.Model.Feedback" %>
        ...
        <div
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown"><a data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle nav-link" href="#">Contact Us</a>
                    <div role="menu" class="dropdown-menu"><a role="presentation" class="dropdown-item" href="#">Feedback</a><a role="presentation" class="dropdown-item" href="#">Feedback</a><a role="presentation" class="dropdown-item" href="#">General Inquiry</a></div>
                </li>
...
<%List<Feedback> feedb = (List<Feedback>)request.getAttribute("feedback"); 
            	for(Feedback com:feedb){   	    
            		 %>	
            	 
    <div class="contact-clean" style="width: 50%;margin-left: 25%;margin-top: 10%;">
        <form method="post" action="UpdateFeedbackServlet">
            ...
            <input type="hidden" value="<%=com.getF_NO()%>" name="fno"><button class="btn btn-primary" type="submit" style="margin-left:10%;">UPDATE</button></form>
            <form method="POST" action="deleteFeedbackServlet"><input type="hidden" value="<%=com.getF_NO()%>" name="fno"><button class="btn btn-primary" type="submit" style="margin-left: 50%;">DELETE</button></form>
